    ...
    <>
      <section className="bg-primary text-primary-foreground">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 md:pt-24 md:pb-20 text-center">
          ...
          <h1 className="font-heading font-bold text-4xl md:text-5xl mb-6">Initiate Corporate Dialogue</h1>
          <p className="font-body text-lg text-primary-foreground/85 max-w-2xl mx-auto leading-relaxed">
            Tell us which vertical you&apos;d like to discuss — Mutual Funds, Real Estate, Insurance
            or Loans — and our leadership desk will respond.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-5 gap-10">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="bg-surface border border-border rounded-2xl p-6">
              ...
              <h3 className="font-heading font-semibold text-primary mb-1">Direct Channel</h3>
            ...
            <div className="bg-surface border border-border rounded-2xl p-6">
              ...
              <h3 className="font-heading font-semibold text-primary mb-1">Operational Desks</h3>
